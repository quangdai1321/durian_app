...
const pm = StyleSheet.create({
  ...
  sheet:    { backgroundColor: "#fff", borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: "88%", paddingBottom: Platform.OS === "ios" ? 34 : 16 },
  header:   { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", backgroundColor: Colors.primary, borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingHorizontal: 20, paddingVertical: 16 },
  title:    { color: "#fff", fontSize: 18, fontWeight: "700" },
  sub:      { color: "rgba(255,255,255,.7)", fontSize: 12, marginTop: 2 },
  closeBtn: { backgroundColor: "rgba(255,255,255,0.2)", borderRadius: 18, width: 32, height: 32, alignItems: "center", justifyContent: "center" },
  closeBtnText: { color: "#fff", fontSize: 16, fontWeight: "700" },
  liveBox:  { backgroundColor: "#e8f5e9", margin: 14, borderRadius: 12, padding: 12 },
  liveTitle:{ fontSize: 12, fontWeight: "700", color: Colors.primary, marginBottom: 8 },
  liveRow:  { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  chip:     { backgroundColor: Colors.primary, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: "rgba(255,213,79,0.4)" },
  chipVariety: { color: "rgba(255,255,255,0.85)", fontSize: 11 },
  chipPrice:   { color: "#ffd54f", fontSize: 13, fontWeight: "700", marginTop: 2 },
  chipSource:  { color: "rgba(255,255,255,0.6)", fontSize: 10, marginTop: 3 },
  scroll:   { flex: 1, paddingHorizontal: 14 },
  tableTitle: { fontSize: 13, fontWeight: "700", color: Colors.text, marginBottom: 10, marginTop: 4 },
  row:      { flexDirection: "row", paddingVertical: 10, paddingHorizontal: 8, borderRadius: 8, alignItems: "flex-start" },
  headRow:  { backgroundColor: Colors.primary, marginBottom: 4 },
  headText: { color: "#fff", fontSize: 12, fontWeight: "700" },
  rowEven:  { backgroundColor: Colors.bg },
  rowOdd:   { backgroundColor: "#fff" },
  col1:     { flex: 1, paddingRight: 8 },
  col2:     { width: 130, alignItems: "flex-end" },
  rowTop:   { flexDirection: "row", alignItems: "center", flexWrap: "wrap", gap: 4, marginBottom: 3 },
  tag:      { borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2 },
  tagText:  { fontSize: 10, fontWeight: "700" },
  rowName:  { fontSize: 13, fontWeight: "700", color: Colors.text, flex: 1 },
  rowUse:   { fontSize: 11, color: Colors.textMuted, lineHeight: 16, marginBottom: 3 },
  rowRegion:{ fontSize: 11, color: Colors.accent },
  rowPrice: { fontSize: 13, fontWeight: "700", color: Colors.primary, textAlign: "right" },
  note:     { backgroundColor: "#fff8e1", borderRadius: 10, padding: 12, marginTop: 12, borderWidth: 1, borderColor: "#ffe082" },
  noteText: { fontSize: 12, color: "#bf360c", lineHeight: 18 },
});
